<?php /* Smarty version Smarty-3.1.15, created on 2021-04-13 10:23:38
         compiled from "/var/www/html/fofoweb/www/templates/randament_clientinew.tpl" */ ?>
<?php /*%%SmartyHeaderCode:73088329607541f2605ca2-50908261%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '86dbdfbe9b87687d50ac3d874504fb96ba8e973e' => 
    array (
      0 => '/var/www/html/fofoweb/www/templates/randament_clientinew.tpl',
      1 => 1618298616,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '73088329607541f2605ca2-50908261',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_607541f26be974_17733099',
  'variables' => 
  array (
    'title' => 0,
    'lista_trasee' => 0,
...
<?php if ($_valid && !is_callable('content_607541f26be974_17733099')) {function content_607541f26be974_17733099($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>((string)$_smarty_tpl->tpl_vars['title']->value)), 0);?>
    ...
    <section id="content">
        <div class="wrapper">
            ...
            <div class="row-fluid span12">
                <form action="/randament_clientinew.php" method="post" id="form_actualizeaza_stoc"
                      style="margin-bottom: 0">
                    <div style="float: left;margin-right: 10px;">
                        <select name="traseu_id" style="width: 180px;">
                            <option value="0">-Traseu-</option>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget">
                        ...
                        <form action="/randament_clientinew.php"
                              method="post"
                              style="margin-bottom: 0">
...
?>
                                        <tr>
                                            ...
                                            <th style="text-align: left;"> <?php echo strtoupper($_smarty_tpl->tpl_vars['client']->value['nume']);?>
</th>
                                            <th style="text-align: center;"> <?php echo $_smarty_tpl->tpl_vars['client']->value['telefon'];?>
</th>
                                            <th>
                                                <?php if (($_smarty_tpl->tpl_vars['randament'.(('_').($_smarty_tpl->tpl_vars['client']->value['id']))]->value['randament_client']!='')) {?>
                                                    <?php $_smarty_tpl->tpl_vars['valoare_randament'] = new Smarty_variable($_smarty_tpl->tpl_vars['randament'.(('_').($_smarty_tpl->tpl_vars['client']->value['id']))]->value['randament_client'], null, 0);?>
                                                    <?php $_smarty_tpl->tpl_vars['procent'] = new Smarty_variable(($_smarty_tpl->tpl_vars['randament'.(('_').($_smarty_tpl->tpl_vars['client']->value['id']))]->value['randament_client']*100)/5, null, 0);?>
                                                <?php } else { ?>
                                                    <?php $_smarty_tpl->tpl_vars['valoare_randament'] = new Smarty_variable($_smarty_tpl->tpl_vars['randamentclientdinfisa'.(('_').($_smarty_tpl->tpl_vars['client']->value['id']))]->value['randament_client'], null, 0);?>
                                                    <?php $_smarty_tpl->tpl_vars['procent'] = new Smarty_variable(($_smarty_tpl->tpl_vars['randamentclientdinfisa'.(('_').($_smarty_tpl->tpl_vars['client']->value['id']))]->value['randament_client']*100)/5, null, 0);?>
                                                <?php }?>
...
"
                                                       ...
                                                       name="randament_<?php echo $_smarty_tpl->tpl_vars['client']->value['id'];?>
