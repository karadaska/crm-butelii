<?php /* Smarty version Smarty-3.1.15, created on 2021-01-20 12:08:18
         compiled from "/home/dinobaby/public_html/crm/www/templates/z_apeluri_clienti.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6514095095fe11dd10cfa20-05189689%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c2f5e362b5e6fac00dcaf144ce30607b1a1debd7' => 
    array (
      0 => '/home/dinobaby/public_html/crm/www/templates/z_apeluri_clienti.tpl',
      1 => 1611137297,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6514095095fe11dd10cfa20-05189689',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_5fe11dd1164286_26286986',
  'variables' => 
  array (
    'title' => 0,
    'traseu_id' => 0,
...
<?php if ($_valid && !is_callable('content_5fe11dd1164286_26286986')) {function content_5fe11dd1164286_26286986($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>((string)$_smarty_tpl->tpl_vars['title']->value)), 0);?>
...
">
            ...
            <div class="row-fluid span12">
                <form action="/z_apeluri_clienti.php" method="post" id="form_actualizeaza_stoc"
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget">
                        ...
                        <form action="/z_apeluri_clienti.php?traseu_id=<?php echo $_smarty_tpl->tpl_vars['traseu_id']->value;?>
&stare_id=<?php echo $_smarty_tpl->tpl_vars['stare_id']->value;?>
" method="post"
                              style="margin-bottom: 0">
...
">
                                            <th style="text-align: center;vertical-align: middle;">
                                                <?php ob_start();?><?php echo ('stoc:').($_smarty_tpl->tpl_vars['client']->value['id']);?>
<?php $_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['client']->value['id']!='' ? $_tmp2 : '-';?>
...
: <?php echo $_smarty_tpl->tpl_vars['target_client']->value['target'];?>
 ...
 $_from = $_smarty_tpl->tpl_vars['client']->value['produse_traseu']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                                                    <?php echo $_smarty_tpl->tpl_vars['produse']->value['nume_produs'];?>

                                                    <input type="text" name="goale_<?php echo $_smarty_tpl->tpl_vars['produse']->value['client_id'];?>
_<?php echo $_smarty_tpl->tpl_vars['produse']->value['tip_produs_id'];?>
" autocomplete="off" value="<?php echo $_smarty_tpl->tpl_vars['produse']->value['goale'];?>
"><br/>
                                                <?php } ?>
                                            </td>
                                            <?php if ($_smarty_tpl->tpl_vars['target_client']->value['produse_traseu']>0) {?>
...
$_smarty_tpl->tpl_vars['target_client']->_loop = true;
?>
                                                        <?php $_smarty_tpl->tpl_vars['cantitati_goale'] = new Smarty_variable(Clienti::getGoaleApelClientiByClientId($_smarty_tpl->tpl_vars['client']->value['id'],$_smarty_tpl->tpl_vars['target_client']->value['tip_produs_id']), null, 0);?>
                                                        <?php echo $_smarty_tpl->tpl_vars['target_client']->value['nume_produs'];?>
...
"
                                            ...
                                            <th style="vertical-align: middle;width: 200px;">
                                                <?php $_smarty_tpl->tpl_vars['observatie_client'] = new Smarty_variable(Clienti::getObservatieApelClientiByClientId($_smarty_tpl->tpl_vars['client']->value['id']), null, 0);?>
...
"
                                                ...
                                                <?php $_smarty_tpl->tpl_vars['urgenta_client'] = new Smarty_variable(Clienti::getUrgentaApelClientiByClientId($_smarty_tpl->tpl_vars['client']->value['id']), null, 0);?>
