<?php /* Smarty version Smarty-3.1.15, created on 2020-12-02 22:39:57
         compiled from "/home/dinobaby/public_html/crm/www/templates/print_suna_traseu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5916687515fa72afacd69c9-16972812%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '366545b4de7fb65b5a980c6fe77f0a694b01dbd8' => 
    array (
      0 => '/home/dinobaby/public_html/crm/www/templates/print_suna_traseu.tpl',
      1 => 1606941703,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5916687515fa72afacd69c9-16972812',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_5fa72afacf7ba3_04524574',
  'variables' => 
  array (
    'id' => 0,
    'nume_traseu' => 0,
...
<?php if ($_valid && !is_callable('content_5fa72afacf7ba3_04524574')) {function content_5fa72afacf7ba3_04524574($_smarty_tpl) {?><script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
...
<section id="content" class="print">
    <div class="wrapper">
        <input type="button" onclick="setPrint();window.print();return false;" id="print_button" name="print_button"
               value="Print"/>
        <a href="/suna_traseu.php?traseu_id=<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
" class="ascuns">
...
?>
                ...
                <th>
                    ...
                    <?php  $_smarty_tpl->tpl_vars['observatie_id'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['observatie_id']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['client_observatie']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['observatie_id']->key => $_smarty_tpl->tpl_vars['observatie_id']->value) {
$_smarty_tpl->tpl_vars['observatie_id']->_loop = true;
?>
                        <?php $_smarty_tpl->tpl_vars['nume_observatie'] = new Smarty_variable(Clienti::getNumeObservatieByObservatieId($_smarty_tpl->tpl_vars['observatie_id']->value), null, 0);?>
                        <?php echo $_smarty_tpl->tpl_vars['nume_observatie']->value['nume_observatie'];?>
    ...
    <table border="1" style="width: 10%;margin-top: 10px;">
        <tr>
            <?php if ($_smarty_tpl->tpl_vars['total_bg_11']->value>0) {?>
                <th style="text-align: left;">
                    <span style="font-weight: bolder;">TOTAL BG 11: <?php echo $_smarty_tpl->tpl_vars['total_bg_11']->value;?>
</span><br/>
                </th>
            <?php }?>
        </tr>
        <tr>
            <?php if ($_smarty_tpl->tpl_vars['total_bg_9']->value>0) {?>
                <th style="text-align: left;">
                    <span style="font-weight: bolder;text-align: left;">TOTAL BG 9: <?php echo $_smarty_tpl->tpl_vars['total_bg_9']->value;?>
</span>
                </th>
            <?php }?>
        </tr>
        <tr>
            <?php if ($_smarty_tpl->tpl_vars['total_ar_8']->value>0) {?>
                <th style="text-align: left;">
                    <span style="font-weight: bolder;text-align: left;">TOTAL AR 8: <?php echo $_smarty_tpl->tpl_vars['total_ar_8']->value;?>
</span>
                </th>
            <?php }?>
        </tr>
        <tr>
            <?php if ($_smarty_tpl->tpl_vars['total_ar_9']->value>0) {?>
                <th style="text-align: left;">
                    <span style="font-weight: bolder;text-align: left;">TOTAL AR 9: <?php echo $_smarty_tpl->tpl_vars['total_ar_9']->value;?>
</span>
                </th>
            <?php }?>
        </tr>
...
?>
                    <span style="font-weight: bolder;">TOTAL Observatii : <?php echo $_smarty_tpl->tpl_vars['numar_obs']->value;?>
</span>
                <?php } ?>
            </th>
        </tr>
...
?>
                                <tr>
                                    <th><?php echo $_smarty_tpl->tpl_vars['urgenta']->value['nume_client'];?>
</th>
                                    <th>
