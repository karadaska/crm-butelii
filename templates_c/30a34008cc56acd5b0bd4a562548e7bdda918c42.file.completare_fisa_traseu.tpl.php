                        ...
                        <?php if (($_smarty_tpl->tpl_vars['fisa']->value['grand_total_vandute_ar_9']!=0||$_smarty_tpl->tpl_vars['fisa']->value['grand_defecte_ar_9']!=0)) {?>
                            <div style="margin-left: 10px;">
                                <table class="table table-bordered table-striped" style="width: 180px;">
                                    <tr class="info">
                                        <td style="text-align: center;font-weight: 900;;color: red;" colspan="2">AR
                                            9 <?php echo $_smarty_tpl->tpl_vars['produs_extra_ar_8']->value['cantitate_extra']>0 ? '+ EXTRA' : '';?>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left;font-weight: 900;">Total cantitati</td>
                                        <td style="text-align: center;font-weight: 900;"><?php echo $_smarty_tpl->tpl_vars['fisa']->value['grand_total_vandute_ar_9']+$_smarty_tpl->tpl_vars['produs_extra_ar_8']->value['cantitate_extra'];?>
</td>
                                    </tr>
                                    <tr class="info">
                                        <td style="text-align: left;font-weight: 900;">Total Valoare</td>
                                        <td style="text-align: center;font-weight: 900;"><?php echo $_smarty_tpl->tpl_vars['fisa']->value['grand_valoare_ar_9']+$_smarty_tpl->tpl_vars['produs_extra_ar_8']->value['cantitate_extra'];?>
</td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left;font-weight: 900;">Total Comision</td>
