<?php /* Smarty version Smarty-3.1.15, created on 2021-03-26 10:22:39
...
?>
                                <option value=<?php echo $_smarty_tpl->tpl_vars['an']->value['id'];?>

                                        <?php if ($_smarty_tpl->tpl_vars['an']->value['id']==$_smarty_tpl->tpl_vars['an']->value) {?> selected="selected" <?php }?>>
                                    <?php echo $_smarty_tpl->tpl_vars['an']->value['an'];?>
...
?>
                                <option value=<?php echo $_smarty_tpl->tpl_vars['perioada']->value['id'];?>
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['perioada']->value['id']==$_smarty_tpl->tpl_vars['perioada']->value) {?> selected="selected" <?php }?>>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <input style="text-align: right"
                                                       value="<?php echo $_smarty_tpl->tpl_vars['client']->value['randament'];?>
"
