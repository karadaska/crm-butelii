...
$stare_produs = getRequestParameter('stare_produs', 2);
...
//                    debug('nu am gasit valoare in tabela produse');
               ...
               (traseu_id, client_id, fisa_id, observatie_id, `data`)
...
//                daca nu am gasit goale fac insert cu cantitati goale prin diferenta
                ...
                $insert_goale = "INSERT INTO fisa_total_intoarcere(fisa_id, traseu_id, tip_produs_id, cantitate, stare_produs, data_intrare)
                     values
                    ('" . $id . "','" . $traseu_by_fisa_generata_id['traseu_id'] . "',
                    '" . $tip_produs_id . "','" . $cantitate_goale . "','" . $stare_goale . "','" . $data_intrare . "')";
...
//    $data_intrare = date('Y-m-d');
    ...
    if ($id_gasit->rowCount() == 1) {
        ...
        $insert_miscari_fisa = "INSERT INTO miscari_fise(fisa_id, casa_marcat, raport_z, valoare_z, tip_alimentare, valoare_alimentare, km, data_intrare)
                     values
                    ('" . $id . "','" . $casa_marcat . "','" . $raport_z . "','" . $valoare_z . "','" . $tip_alimentare . "','" . $valoare_alimentare . "','" . $km . "','" . $data_intrare . "')";
