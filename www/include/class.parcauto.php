...
//    Scoate starea masinii activa/desfiintata
    ...
    public static function getTotalCantitatiExtraBySoferIdAndTraseuId($sofer_id, $traseu_id, $masina_id, $opts = array())
    {
        $ret = null;
        $tip_produs_id = isset($opts['tip_produs_id']) ? $opts['tip_produs_id'] : 0;
        $data_start = isset($opts['data_start']) ? $opts['data_start'] : 0;
...
//    }
    ...
    public static function getTotalCantitatiExtraBySoferIdProdusId($sofer_id = 0, $tip_produs_id, $opts = array())
    {
        $ret = null;
        $data_start = isset($opts['data_start']) ? $opts['data_start'] : 0;
        $data_stop = isset($opts['data_stop']) ? $opts['data_stop'] : 0;
    ...
    public static function getTotalCantitatiExtraByMasinaIdProdusId($masina_id = 0, $tip_produs_id, $opts = array())
    {
        $ret = null;
        $data_start = isset($opts['data_start']) ? $opts['data_start'] : 0;
        $data_stop = isset($opts['data_stop']) ? $opts['data_stop'] : 0;
        ...
        if ($result) {
            ...
            foreach ($a as $item) {
                ...
                foreach ($ret['produse_sofer'] as $tip_produs_id => $item_tip_produs) {
                    ...
                    $r['total_produse_extra'][$tip_produs_id] = self::getTotalCantitatiExtraBySoferIdAndTraseuId($item['sofer_id'], $item['traseu_id'], $item['masina_id'], array(
                        'tip_produs_id' => $tip_produs_id,
                        'data_start' => $data_start,
                        'data_stop' => $data_stop
                    ));
                    ...
                    $ret['grand_extra'][$tip_produs_id] = self::getTotalCantitatiExtraBySoferIdProdusId($item['sofer_id'], $tip_produs_id, array(
                        'data_start' => $data_start,
                        'data_stop' => $data_stop
                    ));
                }
    ...
    public static function getRaportLivrariDepozite($depozit_id, $opts = array())
    {
        ...
        $query = "SELECT a.id, a.depozit_id, a.masina_id, a.sofer_id, b.nume as nume_sofer,
                  ...
                  AND a.data_intrare <= '" . $data_stop . "'
                  AND a.sters = 0
                  GROUP BY a.masina_id, a.sofer_id, a.traseu_id
                  ORDER BY c.nume ASC           
                  ";
        ...
        if ($result) {
            ...
            foreach ($a as $item) {
                ...
                foreach ($ret['produse_depozit'] as $tip_produs_id => $item_tip_produs) {
                    ...
                    $ret['grand'][$tip_produs_id] = Produse::getTotalCantitatiByDepozitIdAndProdusId($item['depozit_id'], $tip_produs_id, array(
                        'data_start' => $data_start,
                        'data_stop' => $data_stop
                    ));
                }
