...
$smarty->assign('name', 'Print livrari masini');
$template_page = "print_livrari_masini.tpl";

$id = getRequestParameter('id', 0);
$smarty->assign('id', $id);

$masina = ParcAuto::getMasinaById($id);
$smarty->assign('masina',$masina);
...
$livrari_masini = ParcAuto::getRaportLivrariMasini($id,
    array(
